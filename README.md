...
- [ ] Explain benefit(s) using `client-side routing`?
  ...
  - Because the entire site is loaded upon the initial request, routing between views is usually faster. It also allows for more interactivity by instantly responding to the actions made by users.
